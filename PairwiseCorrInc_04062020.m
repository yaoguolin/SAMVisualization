...
hold off
print([graphsDir dirSep 'Correlation_SAM_Inc_group03182021_reverse'], '-djpeg');
...
set(gca, 'visible','off')
print([graphsDir dirSep 'Correlation_SAM_Inc_group_legend02262021_reverse'], '-djpeg');
...
hold on
s = scatter([1:4],squeeze(tradeoffsyn_frac_full_matrix(i,j,:)),400 * ones(4, 1),colorMap2,'filled');
hold on
...
hold off
print([graphsDir dirSep 'Correlation_SAM_total'], '-djpeg');
