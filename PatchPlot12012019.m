...
dir_fig = [dir 'PatchPlots\05172020\'];
...
% change variable here
AllScore.FLS = LinearScroeTrans_f(Econ_Trans.FLS,-6.6, -2.5,100/3,200/3);
EconS.FLS = AllScore.FLS;
...
for co = 1:1:218
[varX,varY] = patchplot_f_color(EnvSB,EconSB,SocSB,envNameL,econNameL,socNameL,L,U,10,10,testYrs,co,FAOSTAT_CoName_FAO);
print(strcat(dir_fig, string(FAOSTAT_CoName_FAO(co))), '-djpeg');
end

     

% [varX,varY] = patchplot_f_flip(EnvSB,EconSB,SocSB,envNameL,econNameL,socNameL,L,U,10,10,testYrs,40,FAOSTAT_CoName_FAO);
% print(strcat(dir_fig, string(FAOSTAT_CoName_FAO(40))), '-djpeg');

% USA
[varX,varY] = patchplot_f_color(EnvSB,EconSB,SocSB,envNameL,econNameL,socNameL,L,U,10,10,testYrs,207,FAOSTAT_CoName_FAO);

% China
[varX,varY] = patchplot_f_color(EnvSB,EconSB,SocSB,envNameL,econNameL,socNameL,L,U,10,10,testYrs,40,FAOSTAT_CoName_FAO);

% Brazil
[varX,varY] = patchplot_f_color(EnvSB,EconSB,SocSB,envNameL,econNameL,socNameL,L,U,10,10,testYrs,26,FAOSTAT_CoName_FAO);

% Australia
[varX,varY] = patchplot_f_color(EnvSB,EconSB,SocSB,envNameL,econNameL,socNameL,L,U,10,10,testYrs,9,FAOSTAT_CoName_FAO);

% India
[varX,varY] = patchplot_f_color(EnvSB,EconSB,SocSB,envNameL,econNameL,socNameL,L,U,10,10,testYrs,89,FAOSTAT_CoName_FAO);

% Ethiopia
[varX,varY] = patchplot_f_color(EnvSB,EconSB,SocSB,envNameL,econNameL,socNameL,L,U,10,10,testYrs,64,FAOSTAT_CoName_FAO);

% Ukarine
[varX,varY] = patchplot_f_color(EnvSB,EconSB,SocSB,envNameL,econNameL,socNameL,L,U,10,10,testYrs,202,FAOSTAT_CoName_FAO);

% Tajikistan
[varX,varY] = patchplot_f_color(EnvSB,EconSB,SocSB,envNameL,econNameL,socNameL,L,U,10,10,testYrs,188,FAOSTAT_CoName_FAO);

print(strcat(dir_fig, string(FAOSTAT_CoName_FAO(207))), '-djpeg');


[varX,varY] = patchplot_f_flip(EnvSB,EconSB,SocSB,envNameL,econNameL,socNameL,L,U,10,10,testYrs,114,FAOSTAT_CoName_FAO);
print(strcat(dir_fig, string(FAOSTAT_CoName_FAO(114))), '-djpeg');

save(['patchplot_score_02232021.mat'],'AllScore', 'AllScoreB');

%% Time series patchplot
[varX,varY] = patchplot_f_color_ts(EnvSB,EconSB,SocSB,envNameL,econNameL,socNameL,L,U,10,10,testYrs,207,FAOSTAT_CoName_FAO);
