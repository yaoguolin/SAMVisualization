...
%Guolin
if isempty(find(strcmp(varargin,'stdc')))==0
    if isempty(varargin{find(strcmp(varargin,'stdc'))+1})==0
        medc = varargin{find(strcmp(varargin,'stdc'))+1};
        plotstd = 1;
    else
        plotstd = 0;
    end
...
for i=i:size(Y,2)
    ...
    if setX == 0
        ...
        %Guolin
        if plotstd == 1
            p(3)=plot([interp1(U(:,i),F(:,i)+i,MX(:,i)+STD(:,i)), interp1(flipud(U(:,i)),flipud(i-F(:,i)),MX(:,i)+STD(:,i)) ],[MX(:,i)+STD(:,i) MX(:,i)+STD(:,i)],stdc,'LineWidth',2);
            p(4)=plot([interp1(U(:,i),F(:,i)+i,MX(:,i)-STD(:,i)), interp1(flipud(U(:,i)),flipud(i-F(:,i)),MX(:,i)-STD(:,i)) ],[MX(:,i)-STD(:,i) MX(:,i)-STD(:,i)],stdc,'LineWidth',2);
        end
    elseif setX == 1
        if plotmean == 1
        ...
        if plotstd == 1
            p(3)=plot([interp1(U(:,i),F(:,i)+i,MX(:,i)+STD(:,i))+x(i)-i, interp1(flipud(U(:,i)),flipud(i-F(:,i)),MX(:,i)+STD(:,i))+x(i)-i],[MX(:,i)+STD(:,i) MX(:,i)+STD(:,i)],stdc,'LineWidth',2);
            p(4)=plot([interp1(U(:,i),F(:,i)+i,MX(:,i)-STD(:,i))+x(i)-i, interp1(flipud(U(:,i)),flipud(i-F(:,i)),MX(:,i)-STD(:,i))+x(i)-i],[MX(:,i)-STD(:,i) MX(:,i)-STD(:,i)],stdc,'LineWidth',2);
...
if plotlegend==1 & plotmean==1 | plotlegend==1 & plotmedian==1 |plotlegend==1 & plotstd==1
    
    if plotmean==1 & plotmedian==1 & plotstd == 1
        L=legend([p(1) p(2) p(3)],'Mean','Median','Std');
