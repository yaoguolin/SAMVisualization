function f_reportcard_threeLayersLong_gradient(cn,env_n,econ_n,soc_n,dim_n,var_n,dimcolrcode,dimlabels,dimsign,varcolrcode,varlabels)
    ...
    totcolr = cmp(round(dimcolrcode(cn,4)),:);
