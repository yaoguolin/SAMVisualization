...
load([projectDir,dirSep,'SAM_Data_Outputs',dirSep,'SAM_Patchplot Scores', dirSep, 'patchplot_score_02232021'])  
...
save([resultsDir dirSep 'SAMcorr_upmidinc.mat'], 'indicatScore','SAMxy_CorrVar','SAMxy_var_CorrN',...
