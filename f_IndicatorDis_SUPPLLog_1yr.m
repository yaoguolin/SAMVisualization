function f_IndicatorDis_SUPPLLog_1yr(var,var_comp,var_name,L,U,minV,maxV,minVy,maxVy,ylb, xlb,yr2000_t,dir,FAOSTAT_CoABR_ISO,RegionCoName,RegionID,RegionName,fig_n)
Yr=1961:2016;
close all;
%yr2000_t= [40 55];
fig_caption={'a','b'};
