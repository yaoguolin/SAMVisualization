...
load([projectDir,dirSep, 'SAM_country_group.mat'])
...
load([projectDir,dirSep,'SAM_Data_Outputs',dirSep,'SAM_Patchplot Scores', dirSep, 'patchplot_score_02232021.mat'])  
...
Co_ID_group = RegionID0.(rgname{r});
...
save([resultsDir,dirSep,'SAMcorr_',rgname{r},'.mat'], 'indicatScore','SAMxy_CorrVar','SAMxy_var_CorrN',...
...
title('Lower Middle Income','FontSize',16)
print([graphsDir dirSep 'Correlation_SAM_01282020lowinc'], '-djpeg');
