...
load([dir 'SAM_Data_Outputs\SAM_Patchplot Scores\patchplot_score_01062021.mat'])
...
Soc_D.REQ.GGG = AllScoreB.GGG;
Soc_D.REQ.LRS = AllScoreB.LRS;
...
VarName = {"Water withdraw", "N surplus","P surplus","Land use change","Greenhouse gas","Soil erosion",...
...
% Australia
cn = 9;
f_reportcard_threeLayersLong(cn,env_n,econ_n,soc_n,dim_n,var_n,RegScore_colr,dimlabels,RegScore_sign,VarScore_colr,VarName)
...
title('Economic','fontSize',20);
set(gca,'XTickLabel',{'Low', 'Lower Middle', 'Upper Middle','High'},'fontSize',14,'fontWeight','bold');
xlabel('Income Groups','fontSize',14,'fontWeight','bold');

  axes(ha(3))
 bb_3 = bar(dimen_total_share(:,:,2),'stacked','EdgeColor', 'None');
title('Environmental','fontSize',20);
set(gca,'XTickLabel',{'Low', 'Lower Middle', 'Upper Middle','High'},'fontSize',14,'fontWeight','bold');
xlabel('Income Groups','fontSize',14,'fontWeight','bold');
set(gca,'XTickLabel',{'Low', 'Lower Middle', 'Upper Middle','High'},'fontSize',14,'fontWeight','bold');
xlabel('Income Groups','fontSize',14,'fontWeight','bold');
...
var_color_percentage = nan(4,4,17);
